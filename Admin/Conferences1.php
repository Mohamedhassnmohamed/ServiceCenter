                     ...
                     <div class="row">
                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                            <div class="page-header">
                                <h1 class="pageheader-title" style="text-align:center;font-size:35px;background-color: #f8d7da;border: 5px solid transparent;border-radius: .25rem;color: MediumSeaGreen;font-family: 'Circular Std Book';line-height: 40px;;font-weight: bold;" >صفحة المؤتمرات</h1>
			...
			?>
		         ...
		         <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12" dir=rtl>
                          ...
                          <div class="card" dir=rtl>
                            <h1 class="card-header" style="text-align:center;color:red;font-style: normal;font-family: 'Circular Std Book';font-weight: bold;">المؤتمرات والمنتديات  <?php echo $faculty1;?> العدد الاجمالي :<?php echo $count;?></h1>
										...
										$Images_Committee = $row['Images_Committee'];
											...
											if($id % 2 ==0 )
											{
												...
												<td style='text-align: center;'>".$seminar_Place."</td>
													...
													<td style='text-align: center;'><a href=deleteConference.php?eid=".$id ." <button class='btn btn-danger' onclick='return ConfirmDelete()'> <i class='fa fa-edit' ></i> حذف</button></td>";
													echo "</tr>";
											}
											else
											{
  ...
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      <div class="modal-header" dir=rtl style="text-align">
        <h3 class="modal-title"  id="exampleModalCenterTitle"  style="text-align: right;color:red;font-size:20px;font-weight: bold;">صصفحة لإضافة المؤتمرات والمنتديات لكلية  <?php echo $faculty1;?></h3>
       ...
       <div class="modal-body" >
                                   <form enctype="multipart/form-data" method="post" action="phpcode/adddConference.php" autocomplete="off">
		  ...
		  <div class="form-group">
            <label for="message-text" class="col-form-label" style="text-align: right;font-size:22px;">عنوان المؤتمر</label>
            <input type="text" class="form-control"  name="title"   required />
          </div>
		  <div class="form-group">
            <label for="message-text" class="col-form-label" style="text-align: right;font-size:22px;">رعاية المؤتمر</label>
            <textarea type="text" class="form-control"  name="lectureres"  rows="2" cols="3" required /></textarea>
          </div>
		   <div class="form-group">
            <label for="message-text" class="col-form-label" style="text-align: right;font-size:22px;">ضيوف المؤتمر</label>
...
<input type="text" class="form-control"  name="Target_group"   />
		   ...
		   <div class="form-group">
            <label for="message-text" class="col-form-label" style="text-align: right;font-size:22px;">مكان اعقاد المؤتمر
</label>
...
<input type="text" class="form-control"  name="participating_party"/>
															  ...
															  <div class="form-group">
            <label for="message-text" class="col-form-label" style="text-align: right;font-size:22px;">الجهات الراعية للمؤتمر
</label>
            <textarea type="text" class="form-control"  name="sponsor"  rows="2" cols="3" required /></textarea>
