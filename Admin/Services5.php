...
<body>
    ...
    <div class="dashboard-main-wrapper">
                     ...
                     <div class="row">
                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                            <div class="page-header">
                                <h1 class="pageheader-title" style="text-align:center;font-size:35px;background-color: #f8d7da;border: 5px solid transparent;border-radius: .25rem;color: MediumSeaGreen;font-family: 'Circular Std Book';line-height: 40px;;font-weight: bold;" >صفحة عرض الخدمات-التجليد</h1>
     ...
     <h1 class="card-header" style="text-align:center;color:red;font-style: normal;font-family: 'Circular Std Book';font-weight: bold;">كافة الخدمات - التجليد</h1>
...
$sql = "SELECT check_form.name,check_form.faculty,services.dateservices,services.id,services.id as idSer,check_form.id as id_message from check_form,services where check_form.id=services.id_message and services.is_finished=0 and services.description=5;
";																																							
