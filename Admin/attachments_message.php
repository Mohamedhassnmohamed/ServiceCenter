...
if($result){
		...
		<td style='text-align: center;'><a href='downloadattach.php?file_id=".$id ."&file_name=".$file_path."'><i class='fa fa-download' style='font-size:25px;color:red'></a></td>
													<td style='text-align: center;'><a href=phpcode/deleteattach.php?eid=".$id ." <button class='btn btn-danger' > <i class='fa fa-edit' ></i> حذف</button></td>
...
<select class="form-control form-control-sm"  name="description" required>
 <option value="استمارة فحص">استمارة فحص
												...
												<option value="إيصال إستلام رسالة مجازاة">إيصال إستلام رسالة مجازاة</option>
																								<option value="ايصال منح الدرجة">ايصال منح الدرجة</option>
																										<option value="إستمارة منح الدرجة">إستمارة منح الدرجة</option>

																										<option value="إستمارة طلب الحصول علي خدمة">إستمارة طلب الحصول علي خدمة</option>
																										<option value="نموذج طلب خدمة البحث">نموذج طلب خدمة البحث</option>

																																							<option value="نموذج طلب تحليل إحصائي">نموذج طلب خدمات المراجعة</option>
