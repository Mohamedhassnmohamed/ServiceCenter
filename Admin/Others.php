...
$sql = "SELECT count(*) as c FROM others";
...
$count=$row["c"];
     ...
     <h1 class="card-header" style="text-align:center;color:red;font-style: normal;font-family: 'Circular Std Book';font-weight: bold;">الفعاليات  لكافة الكليات العدد الاجمالي :<?php echo $count;?></h1>
                                ...
                                <table id="dataTables-example2" class="table table-striped table-bordered table-hover"  dir=rtl>
                                    <thead style="background-color: DodgerBlue;font-size:17px; ">
                                        <tr>
											...
											<th style="text-align: center;">كافة الفعاليات</th>
                                        </tr>
                                    </thead>
                                    <tbody>
										...
										$faculty=$row['faculty'];
											...
											if($id % 2 ==0 )
											{
												...
												<td style='text-align: center;'>".$faculty."</td>
													...
													<td style='text-align: center;'><a href=OthersFaculty.php?id_user=".$id." ><button class='btn btn-primary'' > <i class='fa fa-edit' ></i>كافة الفعاليات</button></td>
