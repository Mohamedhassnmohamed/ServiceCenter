...
<body>
    ...
    <div class="dashboard-main-wrapper">
        ...
        <div class="dashboard-wrapper">
                     ...
                     <div class="row">
                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                            <div class="page-header">
                                <h1 class="pageheader-title" style="text-align:center;font-size:35px;background-color: #f8d7da;border: 5px solid transparent;border-radius: .25rem;color: MediumSeaGreen;font-family: 'Circular Std Book';line-height: 40px;;font-weight: bold;" >صفحة الدورات التدريبية</h1>
			...
			$sql = "SELECT count(*) as c FROM courses";
...
$count=$row["c"];
     ...
     <h1 class="card-header" style="text-align:center;color:red;font-style: normal;font-family: 'Circular Std Book';font-weight: bold;">الدورات التدريبية لكافة الكليات العدد الاجمالي :<?php echo $count;?></h1>
...
$sql = "SELECT courses.`id` as sid,courses.`id_user`,courses.title,courses.lectureres,courses.`Target_group`,courses.`seminar_Place`,courses.date,courses.number_participates,courses.participating_party,courses.seminar_objectives,courses.connection_with,courses.Images_Committee,user.faculty FROM courses,user where user.id=courses.id_user order by courses.id desc";
$result = mysqli_query($conn,$sql);
if($result){
                                ...
                                <table id="dataTables-example2" class="table table-striped table-bordered table-hover"  dir=rtl>
                                    <thead style="background-color: DodgerBlue;font-size:17px; ">
                                        <tr>
											...
											<th style="text-align: center;">كافة الدورات التدريبية</th>
                                        </tr>
                                    </thead>
                                    <tbody>
										...
										$faculty=$row['faculty'];
											...
											if($id % 2 ==0 )
											{
												...
												<td style='text-align: center;'>".$faculty."</td>
													...
													<td style='text-align: center;'><a href=CoursesFaculty.php?id_user=".$id." ><button class='btn btn-primary'' > <i class='fa fa-edit' ></i>كافة الدورات التدريبية</button></td>
