                     ...
                     <div class="row">
                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                            <div class="page-header">
                                <h2 class="pageheader-title" style="text-align:center;background-color: #f8d7da;border: 5px solid transparent;border-radius: .25rem;color: #721c24;    font-family: 'Circular Std Book';line-height: 40px;;font-weight: bold;" > صفحة المؤتمرات والمنتديات لكلية معينة</h2>
			...
			?>
		         ...
		         <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12" dir=rtl>
                          ...
                          <div class="card" dir=rtl>
                            <h3 class="card-header" style="text-align:center;color:red;font-style: normal;font-family: 'Circular Std Book';font-weight: bold;">المؤتمرات والمنتديات لكلية <?php echo $faculty1;?> العدد الاجمالي :<?php echo $count;?></h2>
