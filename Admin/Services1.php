...
<body>
    ...
    <div class="dashboard-main-wrapper">
                     ...
                     <div class="row">
                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                            <div class="page-header">
                                <h1 class="pageheader-title" style="text-align:center;font-size:35px;background-color: #f8d7da;border: 5px solid transparent;border-radius: .25rem;color: MediumSeaGreen;font-family: 'Circular Std Book';line-height: 40px;;font-weight: bold;" >صفحة الخدمات -<?php echo $ServecesText;?></h1>
     ...
     <h1 class="card-header" style="text-align:center;color:red;font-style: normal;font-family: 'Circular Std Book';font-weight: bold;">خدمات -<?php echo $ServecesText;?></h1>
                              <div class="table-responsive" dir=rtl>       
                                <table id="dataTables-example" class="table table-striped table-bordered table-hover"  dir=rtl>
                                    <thead style="background-color: DodgerBlue;font-size:17px; ">
                                        <tr>
										<th style="text-align: center;">مسلسل رقم</th>
										...
										<th style="text-align: center;">الكلية
											...
											<th style="text-align: center;">أستمارة  الطلب</th>
...
$sql = "SELECT check_form.name,check_form.faculty,services.dateservices,services.id,services.id as idSer,check_form.id as id_message from check_form,services where check_form.id=services.id_message and services.is_finished=0 and services.description='$sertype';
";																																							
...
if($result){
										...
										$name=$row["name"];
											...
											if($id_serveces % 2 ==0 )
											{
												...
												<td style='text-align: center;'>".$id_message."</td>
												...
												<td style='text-align: center;'>".$faculty."</td>
													...
													<td style='text-align: center;'><a href=downloadWord.php?eid=".$id_serveces ."  <i class='fa fa-download' style='font-size:25px;color:red'></a></td>
													<td style='text-align: center;'><a href=attachments_message_Services.php?services_id=".$id_serveces."&meesage_id=".$id_message." <button class='btn btn-primary'> <i class='fa fa-edit' ></i> المرفقات</button></td>
													<td style='text-align: center;'><a href=PapersTopics_Services.php?services_id=".$id_serveces."&meesage_id=".$id_message." <button class='btn btn-primary'> <i class='fa fa-edit' ></i> الخدمات-الجوابات</button></td>
											...
											else
											{
												...
												<td style='text-align: center;'>".$faculty."</td>
													...
													echo "<td style='text-align: center;'><a href=showdetails2.php?eid=".$id_serveces ." <button class='btn btn-primary'> <i class='fa fa-edit' ></i> التفاصيل</button></td>
													<td style='text-align: center;'><a href=downloadWord.php?eid=".$id_serveces ."  <i class='fa fa-download' style='font-size:25px;color:red'></td>
													<td style='text-align: center;'><a href=attachments_message_Services.php?services_id=".$id_serveces."&meesage_id=".$id_message." <button class='btn btn-primary'> <i class='fa fa-edit' ></i> المرفقات</button></td>
													<td style='text-align: center;'><a href=PapersTopics_Services.php?services_id=".$id_serveces."&meesage_id=".$id_message." <button class='btn btn-primary'> <i class='fa fa-edit' ></i> الخدمات-الجوابات</button></td>
