...
if(isset($_FILES['file_name'])&&file_exists($_FILES['file_name']['tmp_name'])&&is_uploaded_file($_FILES['file_name']['tmp_name']))
{
    ...
    $destination = '../MessageAttachments/'.$message_id.$services_id.$description.$filename;
...
/////////////////////////////
$sql = "INSERT INTO message_attachments_services(file_path,description,message_id,services_id)VALUES ('$Images_Committee','$description','$message_id','$services_id')";
