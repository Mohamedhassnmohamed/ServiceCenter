...
@page { margin: 0; }
	...
	$seminar_id = $_GET['eid'];
	$sql = "SELECT * FROM Conferences,user where user.id=Conferences.id_user and Conferences.id='$seminar_id'";
...
if($result=mysqli_query($conn,$sql)){
	...
	?>
		<header>
			<h1 style="text-align:center;font-size:30px;">صفحة بيانات مؤتمر أو منتدي بعنوان <?php echo $title;?></h1>
		...
		<article>
			...
			<tr>
					<th style="text-align: right:width:30%;;font-size:20px;"><span >عنوان المؤتمر
</span></th>
					<td style="text-align: center:width:70%;;font-size:20px;"><span ><?php echo $title; ?></span></td>
				</tr>
				
				<tr>
					<th style="text-align: right:width:30%;;font-size:20px;"><span >رعاية المؤتمر
</span></th>
					<td style="text-align: center:width:70%;;font-size:20px;"><span ><?php echo $lectureres; ?> </span></td>
				</tr>
				<tr>
					<th style="text-align: right:width:30%;;font-size:20px;"><span >ضيوف المؤتمر

</span></th>
					<td style="text-align: center:width:70%;;font-size:20px;"><span ><?php echo $guests; ?> </span></td>
				</tr>
				<tr>
				...
				<tr>
					<th style="text-align: right:width:30%;font-size:20px;"><span >المشاركين وعددهم</span></th>
				...
				<tr>
					<th style="text-align: right:width:30%;font-size:20px;"><span >الجهات الراعية للمؤتمر</span></th>
					<td style="text-align: center:width:70%;;font-size:20px;"><span ><?php echo $sponsors; ?> </span></td>
				</tr>
				<tr>
				...
				<tr>
					<th style="text-align: right:width:30%;font-size:20px;"><span >التوصيات

</span></th>
					<td style="text-align: center:width:70%;font-size:20px;"><?php echo $recommedation; ?></td>
				</tr>
