	...
	?>
		...
		<article>
			...
			<tr>
				...
				<tr>
					<th style="text-align: right:width:30%;font-size:20px;"><span >رقم تليفون المشرف

</span></th>

					<td style="text-align: center:width:70%;font-size:20px;"><span ><?php echo $SUP_Phone; ?> </span></td>
				</tr>
				<tr>
				...
				<tr>
					<th style="text-align: right:width:30%;font-size:20px;"><span >نوع الخدمة المطلوبة

</span></th>
					<td style="text-align: center:width:70%;font-size:20px;"><?php echo $description; ?></td>
				</tr>
				<tr>
				...
				<tr>
					<th style="text-align: right:width:30%;font-size:20px;"><span >تاريخ الطلب 

</span></th>
					<td style="text-align: center:width:70%;font-size:20px;"><?php echo $dateservices; ?></td>
				</tr>
