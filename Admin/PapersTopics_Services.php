...
?>
 ...
 <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12" dir=rtl>
                                <form enctype="multipart/form-data" method="post" action="phpcode/DownlodPapersServices.php" autocomplete=false;>
...
<option  value="1" selected>نموذج طلب خدمة البحث</option>
<option  value="2" >نموذج طلب تحليل احصائي</option>
<option  value="3" >نموذج طلب خدمة المراجعة</option>
<option  value="4" >إفادة بخدمة المراجعة</option>
												 ...
												 <input type="hidden" name="mid" value="<?php echo $register_id ;?>"/>
