...
<html>
	<head>
		<meta charset="utf-8">
		<title>صفحة بيانات ورشة عمل</title>
...
@page { margin: 0; }
	...
	$job_id = $_GET['eid'];
	$sql = "SELECT * FROM job,user where user.id=job.id_user and job.id='$job_id'";
...
if($result=mysqli_query($conn,$sql)){
	...
	?>
		<header>
			<h1 style="text-align:center;font-size:30px;">صفحة بيانات ورشة عمل بعنوان<?php echo $title;?></h1>
		...
		<article>
			...
			<tr>
					<th style="text-align: right:width:30%;;font-size:20px;"><span >عنوان الورشة
</span></th>
