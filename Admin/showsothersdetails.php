...
<html>
	<head>
		<meta charset="utf-8">
		<title>صفحة بيانات فعالية</title>
...
@page { margin: 0; }
	...
	$others_id = $_GET['eid'];
	$sql = "SELECT * FROM others,user where user.id=others.id_user and others.id='$others_id'";
...
if($result=mysqli_query($conn,$sql)){
	...
	?>
		<header>
			<h1 style="text-align:center;font-size:30px;">صفحة بيانات فعالية بعنوان  <?php echo $title;?></h1>
		...
		<article>
			...
			<tr>
					<th style="text-align: right:width:30%;;font-size:20px;"><span >عنوان الفعالية
</span></th>
					<td style="text-align: center:width:70%;;font-size:20px;"><span ><?php echo $title; ?></span></td>
				</tr>
				
				<tr>
					<th style="text-align: right:width:30%;;font-size:20px;"><span >راعى الفاعلية 
</span></th>
				...
				<tr>
					<th style="text-align: right:width:30%;;font-size:20px;"><span >مكان الفعالية
