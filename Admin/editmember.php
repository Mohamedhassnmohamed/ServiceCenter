...
$id_staff=$_GET["eid"];
$sql = "SELECT * FROM user WHERE id='$id_staff'";
...
?>
 ...
 <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12" dir=rtl>
                                <form enctype="multipart/form-data" method="post" action="phpcode/editmemberinfo.php" autocomplete=false;>
                                <div class="card" dir=rtl>
                                    <h5 class="card-header" class="text-right" style="text-align: right;color: #004085; font-family: 'Circular Std Book';italics; border: 1px solid transparent;;background-color: #f8d7da;;border-color:#f5c6cb;;border-radius: .25rem;;font-weight: bold;">عدل علي البيانات الاتيه</h5>
                                    <div class="card-body" style="text-align: right;">
									 ...
									 <input id="inputText3" style="text-align: right;" name="name" value="<?php echo $name; ?>" type="text" class="form-control"  >
											...
											<div class="form-group" >
                                                ...
                                                <input id="inputText3" style="text-align: right;" name="national_number" value="<?php echo $national_number;?>" type="text" class="form-control"  >
                                            </div>
											
											<div class="form-group">
                                                <label for="inputText3" class="col-form-label" >الإيميل</label>
                                                <input id="inputText3" style="text-align: right;" name="email" type="text" class="form-control" value="<?php echo $row["email"]; ?>">
                                            </div>
											<div class="form-group">
                                                <label for="inputText3" class="col-form-label" >الرقم السري</label>
                                                <input id="inputText3" style="text-align: right;" name="password" type="text" class="form-control" value="<?php echo $row["password"]; ?>">
                                            </div>
											<div class="form-group">
            <label for="message-text" class="col-form-label" style="text-align: right">نوع الحساب
</label>
