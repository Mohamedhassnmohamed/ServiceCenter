                     ...
                     <div class="row">
                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                            <div class="page-header">
                                <h1 class="pageheader-title" style="text-align:center;font-size:35px;background-color: #f8d7da;border: 5px solid transparent;border-radius: .25rem;color: MediumSeaGreen;font-family: 'Circular Std Book';line-height: 40px;;font-weight: bold;" >صفحة ورش العمل</h1>
...
$sql = "SELECT count(*) as c FROM job";
...
$count=$row["c"];
     ...
     <h1 class="card-header" style="text-align:center;color:red;font-style: normal;font-family: 'Circular Std Book';font-weight: bold;">ورش العمل لكافة الكليات العدد الاجمالي :<?php echo $count;?></h1>
...
$sql = "SELECT job.`id` as sid,job.`id_user`,job.title,job.lectureres,job.`Target_group`,job.`seminar_Place`,job.date,job.number_participates,job.participating_party,job.seminar_objectives,job.connection_with,job.Images_Committee,user.faculty FROM job,user where user.id=job.id_user  order by job.date desc";
$result = mysqli_query($conn,$sql);
if($result){
                                ...
                                <table id="dataTables-example2" class="table table-striped table-bordered table-hover"  dir=rtl>
                                    <thead style="background-color: DodgerBlue;font-size:17px; ">
                                        <tr>
											...
											<th style="text-align: center;">كافة ورش العمل</th>
                                        </tr>
                                    </thead>
                                    <tbody>
										...
										$faculty=$row['faculty'];
											...
											if($id % 2 ==0 )
											{
												...
												<td style='text-align: center;'>".$faculty."</td>
													...
													<td style='text-align: center;'><a href=JobFaculty.php?id_user=".$id." ><button class='btn btn-primary'' > <i class='fa fa-edit' ></i>كافة ورش العمل</button></td>
