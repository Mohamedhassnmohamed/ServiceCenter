                     ...
                     <div class="row">
                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                            <div class="page-header">
                                <h1 class="pageheader-title" style="text-align:center;font-size:35px;background-color: #f8d7da;border: 5px solid transparent;border-radius: .25rem;color: MediumSeaGreen;font-family: 'Circular Std Book';line-height: 40px;;font-weight: bold;" >صفحة التقارير</h1>
...
$count=$row["c"];
     ...
     <h1 class="card-header" style="text-align:center;color:red;font-style: normal;font-family: 'Circular Std Book';font-weight: bold;">تقارير كافة الكليات  العدد الاجمالي :<?php echo $count;?></h1>
...
<input type="file" class="form-control"  name="HealthCommittee"   />
		   ...
		   <div class="form-group">
            <label for="message-text" class="col-form-label" style="text-align: right">لجنة ترشيد الطاقة
</label>
<input type="file" class="form-control"  name="PowerCommittee" />

													          </div>
		  
		   <div class="form-group">
            <label for="message-text" class="col-form-label" style="text-align: right">لجنة ترشيد المياة
</label>
<input type="file" class="form-control"  name="WaterCommittee" />

													          </div>
		  
		   <div class="form-group">
            <label for="message-text" class="col-form-label" style="text-align: right">لجنة منع التدخين
</label>
<input type="file" class="form-control"  name="SmokingCommittee"   />

													          </div>
		  
		   <div class="form-group">
            <label for="message-text" class="col-form-label" style="text-align: right">لجنة أعمال الصيانة
</label>
<input type="file" class="form-control"  name="ReparingCommittee"/>

													          </div>
		  
		   <div class="form-group">
            <label for="message-text" class="col-form-label" style="text-align: right">لجنة متابعة الكافتريا
</label>
<input type="file" class="form-control"  name="CafatiriaCommittee"/>

													          </div>
		  
		   <div class="form-group">
            <label for="message-text" class="col-form-label" style="text-align: right">لجنة التخلص من النفايات
</label>
<input type="file" class="form-control"  name="WasteCommittee"/>

													          </div>
		  
		   <div class="form-group">
            <label for="message-text" class="col-form-label" style="text-align: right">لجنة الاجراءات الاحترازية
</label>
<input type="file" class="form-control"  name="MeasuresCommittee"/>

													          </div>
		  
		   <div class="form-group">
            <label for="message-text" class="col-form-label" style="text-align: right">لجان أخرى
</label>
<input type="file" class="form-control"  name="OthersCommittee"/>

	
      
      </div>
      <div class="modal-footer">
        <button type="submit" class="btn btn-primary" style="height:40px; width:120px";>اضافه</button>
		  </form>
      </div>
    </div>
  </div>
                                ...
                                <table id="dataTables-example2" class="table table-striped table-bordered table-hover"  dir=rtl>
                                    <thead style="background-color: DodgerBlue;font-size:17px; ">
                                        <tr>
											...
											<th style="text-align: center;">كافة التقارير</th>
                                        </tr>
                                    </thead>
                                    <tbody>
										...
										$faculty=$row['faculty'];
											...
											if($id % 2 ==0 )
											{
												...
												<td style='text-align: center;'>".$faculty."</td>
													...
													<td style='text-align: center;'><a href=ReportsFaculty.php?id_user=".$id." ><button class='btn btn-primary' > <i class='fa fa-edit' ></i>كافة التقارير</button></td>
