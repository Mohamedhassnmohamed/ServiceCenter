                     ...
                     <div class="row">
                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                            <div class="page-header">
                                <h1 class="pageheader-title" style="text-align:center;font-size:35px;background-color: #f8d7da;border: 5px solid transparent;border-radius: .25rem;color: MediumSeaGreen;font-family: 'Circular Std Book';line-height: 40px;;font-weight: bold;" >صفحة الفعاليات الأخرى (قوافل – احتفالية- غيرها)</h1>
			...
			?>
		         ...
		         <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12" dir=rtl>
                          ...
                          <div class="card" dir=rtl>
                            <h1 class="card-header" style="text-align:center;color:red;font-style: normal;font-family: 'Circular Std Book';font-weight: bold;">الفعاليات الأخرى لكلية   <?php echo $faculty1;?> العدد الاجمالي :<?php echo $count;?></h1>
										...
										$Images_Committee = $row['Images_Committee'];
											...
											if($id % 2 ==0 )
											{
												...
												<td style='text-align: center;'>".$sponsors."</td>
													...
													<td style='text-align: center;'><a href=deleteOthers.php?eid=".$id ." <button class='btn btn-danger' onclick='return ConfirmDelete()'> <i class='fa fa-edit' ></i> حذف</button></td>";
													echo "</tr>";
											}
											else
											{
  ...
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      <div class="modal-header" dir=rtl style="text-align">
        <h3 class="modal-title"  id="exampleModalCenterTitle"  style="text-align: right;color:red;font-size:20px;font-weight: bold;">صفحة إضافة بيانات فعاليات لكلية  <?php echo $faculty1;?></h3>
       ...
       <div class="modal-body" >
                                   <form enctype="multipart/form-data" method="post" action="phpcode/addOthers.php" autocomplete="off">
		  ...
		  <div class="form-group">
            <label for="message-text" class="col-form-label" style="text-align: right;font-size:22px;">ععنوان الفعالية</label>
            <input type="text" class="form-control"  name="title"   required />
          </div>
		  <div class="form-group">
            <label for="message-text" class="col-form-label" style="text-align: right;font-size:22px;">راعى الفاعلية </label>
            <input type="text" class="form-control"  name="sponsor"  required /></textarea>
          </div>
...
<input type="text" class="form-control"  name="Target_group"   />
		   ...
		   <div class="form-group">
            <label for="message-text" class="col-form-label" style="text-align: right;font-size:22px;">مكان الفعالية
</label>
