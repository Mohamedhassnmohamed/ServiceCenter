...
<td 'text-align: center;'> ".$type."</td>";
													...
													if($row['type']=="user")echo "<td style='text-align: center;'><a href=editmember.php?eid=".$id ." <button class='btn btn-danger' > <i class='fa fa-edit' ></i> تعديل</button></td>";else echo "<td></td>";
      ...
      <div class="modal-header" dir=rtl style="text-align">
       ...
       <div class="modal-body">
          ...
          <div class="form-group">
            <label for="message-text" class="col-form-label" style="text-align: right;font-size:22px;">أسم السيد الوكيل</label>
                                ...
                                <table id="dataTables-example2" class="table table-striped table-bordered table-hover"  dir=rtl>
                                    <thead style="background-color: DodgerBlue;font-size:17px; ">
                                        <tr>
											...
											<th style="text-align: center;">كافة  التفاصيل</th>
                                        </tr>
                                    </thead>
                                    <tbody>
										...
										$faculty=$row['faculty'];
											...
											if($id % 2 ==0 )
											{
												...
												<td style='text-align: center;'>".$faculty."</td>
													...
													<td style='text-align: center;'><a href=AllDetails.php?id_user=".$id." ><button class='btn btn-primary'' > <i class='fa fa-edit' ></i>كافة  التفاصيل</button></td>
