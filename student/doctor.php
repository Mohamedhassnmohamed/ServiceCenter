                    ...
                    <div class="row">
                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                            <div class="page-header">
                                <h2 class="text-center" style="background-color: #cce5ff;border-color: #b8daff;border: 5px solid transparent;border-radius: .25rem;color:black;font-size: 30px;line-height: 40px;    font-family: 'Circular Std Book'">درجه الدكتوراه</h2>
 ...
 <div class="page-section" id="overview">
                                <div class="row" dir=rtl>
                                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12" dir=rtl>
                                       ...
                                       <ul class="">
                                            <li class="text-right">الدكتوراه في التمريض الباطنى والجراحى 
									...
									<div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12" dir=rtl>
                                        ...
                                        <ul class="">
                                            <li class="text-right">الدكتوراه في تمريض الصحة النفسية والعقلية 
									...
									<div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12" dir=rtl>
                                        ...
                                        <ul class="">
                                            <li class="text-right">الدكتوراه  في تمريض صحة الأم وحديثي الولادة
									...
									<div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12" dir=rtl>
                                      ...
                                      <ul class="">
                                            <li class="text-right">الدكتوراه في تمريض الأطفال  
									...
									<div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12" dir=rtl>
                                        ...
                                        <ul class="">
                                            <li class="text-right">الدكتوراه في تمريض المسنين 
									...
									<div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12" dir=rtl>
                                       ...
                                       <ul class="">
                                            <li class="text-right">الدكتوراه في تمريض العناية الحرجة والطوارئ 
									...
									<div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12" dir=rtl>
                                       ...
                                       <ul class="">
                                            <li class="text-right">الدكتوراه في  تمريض صحة الأسرة و المجتمع 
									...
									<div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12" dir=rtl>
                                       ...
                                       <ul class="">
                                            <li class="text-right" >الدكتوراه في إدارة التمريض 
									...
									<div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12" dir=rtl>
                                       ...
                                       <ul class="">
                                            <li class="text-right">  أن يستوفى الطالب شروط القسم العلمي وأن يحصل على موافقة مجلس القسم المختص ومجلس الكلية  .			


 
</li>
                                                <li class="text-right"> بالنسبة للمدرسين المساعدين من الخارج (يشترط موافقة أ.د/رئيس الجامعة و أ.د/عميد الكلية الخاصة به ).			
</li>
									...
									<div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12" dir=rtl>
                                       ...
                                       <ul class="">
                                            <li class="text-right"> استمارة القيد وبيان حالة "توجد بإدارة الدراسات العليا"
                                                ...
                                                <li class="text-right">  شهادة الماجستير

</li>
												                                                <li class="text-right"> شهادة تقديرات لدرجة الماجستير

</li>

                                                <li class="text-right">بيان حالة من جهة العمل

</li>

                                                <li class="text-right">شهادة عدم توقيع أي جزاء تأديبي طوال فترة الدارسة                           
</li>
												                                                <li class="text-right"> شهادة ميلاد للحاصل على درجة الماجستير من جامعة أخرى                         
  ...
  <li class="text-right"> دليل الدراسات العليا 75ج
