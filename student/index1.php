                     ...
                     <div class="row">
                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                            <div class="page-header">
                                <h1 class="pageheader-title" style="text-align:center;font-size:35px;background-color: #f8d7da;border: 5px solid transparent;border-radius: .25rem;color: MediumSeaGreen;font-family: 'Circular Std Book';line-height: 40px;;font-weight: bold;" >المستودع الرقمي-كافة الموضوعات</h1>
...
$id_user=$_SESSION["id_user"];
			$sql = "SELECT count(*) as c FROM check_form,user where user.id=check_form.id_user and check_form.id_user='$id_user'";
...
$count=$row["c"];
     ...
     <h1 class="card-header" style="text-align:center;color:red;font-style: normal;font-family: 'Circular Std Book';font-weight: bold;">كافة الموضوعات -العدد الإجمالي  :<?php echo $count;?></h1>
...
<th style="text-align: center;">درجة الرسالة
</th>
									...
									include_once("dbconec.php");
$sql = "SELECT * from check_form  where id_user='$id_user' order by check_form.id desc";
$result = mysqli_query($conn,$sql);
if($result){
		    ...
		    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12" dir=rtl>
                          ...
                          <div class="card" dir=rtl>
     <h1 class="card-header" style="text-align:center;color:red;font-style: normal;font-family: 'Circular Std Book';font-weight: bold;">الخدمات  </h1>
                              <div class="table-responsive" dir=rtl>       
...
<th style="text-align: center;">تاريخ الطلب</th>
									...
									include_once("dbconec.php");
$sql = "SELECT * from check_form,Services  where check_form.id=Services.id_message and  id_user='$id_user'";
$result = mysqli_query($conn,$sql);
if($result){
										...
										$description=$row["description"];
											...
											$Notes=$row["Notes"];
											if($description==1)
												$description="البحث عن المصادر";
											else if($description==2)
												$description="الكتابة والتنسيق";
											else if($description==3)
												$description="الجرافيك";
											else if($description==4)
												$description="التحليل الاحصائي";
											else if($description==5)
												$description="التجليد";
											else if($description==6)
												$description="الطباعه والنسخ";
											else if($description==7)
												$description="التصحيح والمراجعة اللغوية";
											else if($description==8)
												$description="المراجعة علي القواعد";
