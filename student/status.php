                            ...
                            <li class="nav-item">
                                ...
                                <div id="submenu-44" class="collapse submenu" style="">
									...
									<li class="nav-item"  style="text-align: right;">
									 ...
									 <li class="nav-item">
                                <a class="nav-link active" href="#" data-toggle="collapse" aria-expanded="false" data-target="#submenu-55" aria-controls="submenu-55"><i class="fa fa-fw fa-rocket"></i>حاله الطلب</a>
                    ...
                    <div class="row">
                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                            <div class="page-header">
                                <h2 class="text-center" style="background-color: #cce5ff;border-color: #b8daff;border: 5px solid transparent;border-radius: .25rem;color:black;font-size: 30px;line-height: 40px;    font-family: 'Circular Std Book'">متابعه حاله طلب القيد</h2>
...
$msg="";
					   $id=$_SESSION["id_user"];
 $sql = "SELECT * FROM registeration WHERE user_id='$id' ORDER BY ID DESC";
$result = mysqli_query($conn,$sql);
 $row = mysqli_fetch_array($result);
...
if($accepted==1){
$msg="تم الموافقة على  القيد من رئيس القسم الرجاء الذهاب للإدارة لتقديم كافة المستندات ورقيا";	

}
else{
	
	$msg="لم يتم مراجعه طلبك من قبل رئيس القسم";
	}
 ...
 <div class="page-section" id="overview">
                                <div class="row" dir=rtl>
                                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12" dir=rtl>
                                        <h2 class="text-right" style="background-color: #f8d7da;border: 3px solid transparent;border-radius: .25rem;color: #721c24;    font-family: 'Circular Std Book';line-height: 30px;"> <?php echo $msg;?></h2>
