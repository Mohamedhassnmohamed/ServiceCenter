                    ...
                    <div class="row">
                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                            <div class="page-header">
                                <h2 class="text-center" style="background-color: #cce5ff;border-color: #b8daff;border: 5px solid transparent;border-radius: .25rem;color:black;font-size: 30px;line-height: 40px;    font-family: 'Circular Std Book'">درجه الماجستير</h2>
 ...
 <div class="page-section" id="overview">
                                <div class="row" dir=rtl>
                                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12" dir=rtl>
                                        <h2 class="text-right" style="background-color: #f8d7da;border: 3px solid transparent;border-radius: .25rem;color: #721c24;    font-family: 'Circular Std Book';line-height: 30px;">قسم التمريض الباطني والجراحي 
</h2>
                                       <ul class="">
                                            <li class="text-right">الماجستير في التمريض الباطنى والجراحى 

</li>
                                                 </ul>
                                    </div>
									<div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12" dir=rtl>
                                        <h2 class="text-right" style="background-color: #f8d7da;border: 3px solid transparent;border-radius: .25rem;color: #721c24;    font-family: 'Circular Std Book';line-height: 30px;">قسم تمريض الصحة النفسية والعقلية 
</h2>
                                        <ul class="">
                                            <li class="text-right">الماجستير في تمريض الصحة النفسية والعقلية 
									...
									<div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12" dir=rtl>
                                        ...
                                        <ul class="">
                                            <li class="text-right">الماجستير  في تمريض صحة الأم وحديثي الولادة
									...
									<div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12" dir=rtl>
                                      ...
                                      <ul class="">
                                            <li class="text-right">الماجستير في تمريض الأطفال  
									...
									<div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12" dir=rtl>
                                       ...
                                       <ul class="">
                                            <li class="text-right">الماجستير في  تمريض صحة الأسرة و المجتمع 
									...
									<div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12" dir=rtl>
                                        ...
                                        <ul class="">
                                            <li class="text-right">الماجستير في تمريض المسنين 
									...
									<div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12" dir=rtl>
                                       ...
                                       <ul class="">
                                            <li class="text-right">الماجستير في تمريض العناية الحرجة والطوارئ 
									...
									<div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12" dir=rtl>
                                       ...
                                       <ul class="">
                                            <li class="text-right">الماجستير في إدارة التمريض 
									...
									<div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12" dir=rtl>
                                       ...
                                       <ul class="">
                                            <li class="text-right"> 1أن يكون الطالب حاصل على البكالوريوس في التمريض في فروع التخصص بتقدير عام "جيد"على الأقل ( C+) أو ما يعادل هذا التقدير من إحدى جامعات جمهورية مصر العربية أو على درجة معادلة لها من جامعة أخري أو معهد علمي معترف به من المجلس الأعلى للجامعات وتقدير"جيد" في مادة التخصص								
                                                ...
                                                <li class="text-right"> بالنسبة للمعيدين من الخارج (يشترط موافقة أ.د/رئيس الجامعة و أ.د/عميد الكلية الخاصة به )</li>
												                                                <li class="text-right">للطلاب الوافدين إلي جانب الشروط السابقة:-
 </li>
 <li class="text-right"> تطبيق القواعد واللوائح الصادرة من إدارة الوافدين والمجلس الأعلى للجامعات
 </li>
 <li class="text-right">معادلة الشهادة من المجلس الاعلي للجامعات ، شهادة صحية بالخلو من مرض الايدز مستخرجه من داخل جمهورية مصر العربية وتسحب جميع الإقرارات الموضحة فيما سبق من إدارة الدراسات العليا بعد استيفاء رسوم الدمغة
 </li>
